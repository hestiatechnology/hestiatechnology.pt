...
const CHAIN = [
  { id: "S1", label: "Fibra", icon: "thread" as const },
  { id: "S2", label: "Fiação", icon: "roll" as const },
  { id: "S3", label: "Tecelagem", icon: "loom" as const },
  { id: "S4", label: "Acabamento", icon: "dye-bath" as const },
];

const CHECKS = [
  { l: "Origem das fibras", v: "Algodão BCI" },
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, margin: "16px 0" }}>
        <div style={{ flexShrink: 0, width: 64, height: 64, borderRadius: 12, background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: 8 }}>
          <img src="/dpp-seal.svg" alt="QR DPP" style={{ width: "100%", height: "100%" }} />
        </div>
        <div style={{ minWidth: 0 }}>
          <div style={{ fontSize: 16, fontWeight: 600, color: "#fff" }}>Tecido Sarja · 280 g/m²</div>
          <div style={{ fontFamily: "'Geist Mono', monospace", fontSize: 11, color: "rgba(255,255,255,0.5)", marginTop: 4 }}>GTIN 05601234567890 · LOTE 2A-0094</div>
          <div style={{ fontFamily: "'Geist Mono', monospace", fontSize: 11, color: "#3CCB7F", marginTop: 2 }}>{scans.toLocaleString("pt-PT")} consultas públicas</div>
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="hero-grid">
          ...
          <div>
            ...
            <h1 style={{ fontSize: "clamp(2.5rem, 5.5vw, 4.75rem)", fontWeight: 700, lineHeight: 1.02, letterSpacing: "-0.04em", margin: "0 0 24px", textWrap: "balance" }}>
              Um passaporte digital para cada{" "}
              <em style={{ fontStyle: "normal", color: "#8AA4DD" }}>produto têxtil</em>.
            </h1>
            <p style={{ fontSize: 18, lineHeight: 1.65, color: "rgba(255,255,255,0.7)", maxWidth: 540, marginBottom: 36 }}>
              O TextileEco é o registo ao nível da fibra — a base central para o Passaporte Digital de Produto exigido pelo ESPR. Gere, partilhe por QR e prove a conformidade de cada artigo que produz.
            </p>
            ...
            <div style={{ display: "flex", gap: 48, marginTop: 56, flexWrap: "wrap" }}>
              {[
                { value: "2027", unit: "", label: "ESPR · DPP obrigatório" },
                { value: "QR · NFC", unit: "", label: "GS1 Digital Link" },
                { value: "100%", unit: "", label: "Rastreável à fibra" },
              ].map((m) => (
                <div key={m.label}>
          ...
          {/* Right: digital product passport card */}
