    ...
    <section style={{
      ...
      <div style={{ position: "relative", maxWidth: 720, margin: "0 auto" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#8AA4DD" }}>Próximo passo</span>
        </div>
        <h2 style={{
          color: "#fff",
          ...
          Pronto para transformar a sua fábrica têxtil?
        </h2>
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 18, marginBottom: 36 }}>
          Junte-se ao programa de acesso antecipado. Lugares limitados — implementamos 8 fábricas até final do ano.
        </p>
