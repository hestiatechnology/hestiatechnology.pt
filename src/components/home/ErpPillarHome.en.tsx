const checks = [
  {
    ...
    desc: "Looms, lots and orders in one dashboard — the data that feeds every passport.",
  },
  {
    title: "Per-lot tracking, yarn to shipment",
    desc: "Shade, GSM, quality holds and digital release, with no double data entry.",
  },
  {
    title: "No painful migration",
    desc: "Imports from your legacy ERP and Excel. Live in weeks, not months.",
  },
];

const KPIS = [
  { label: "OEE", value: "84.3%" },
  { label: "Lots today", value: "148" },
  { label: "Looms", value: "16/18" },
];

export default function ErpPillarHomeEn() {
  return (
    <section style={{
          ...
          <div style={{ position: "relative", order: 1 }} className="erp-visual">
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--muted-foreground)" }}>Hestia ERP · Line 2</div>
          ...
          <div style={{ order: 2 }} className="erp-copy">
            <div style={{ display: "inline-flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--primary)" }}>
                The foundation · Hestia ERP
              </span>
            </div>
            <h2 style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 16 }}>
              A passport is only trustworthy<br />if the <em style={{ fontStyle: "normal", color: "var(--primary)" }}>data</em> is too.
            </h2>
            <p style={{ fontSize: 18, color: "var(--muted-foreground)", lineHeight: 1.6, marginTop: 16 }}>
              Underneath TextileEco runs a full textile ERP. It captures every lot, loom and order in real time — so the Digital Product Passport is born from the factory's actual data, not from estimates.
            </p>
