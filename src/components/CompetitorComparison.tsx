...
const copy = {
  ...
  pt: {
    ...
    subtitle: "Escolha um concorrente e tamanho de empresa têxtil para ver uma comparação real de custos.",
    label: "Comparação",
    competitor: "Escolha o Concorrente",
    factorySize: "Tamanho da Empresa Têxtil",
    small: "Pequena Empresa Têxtil",
    smallDesc: "1 Gestor + 15 Operadores",
    mid: "Empresa Têxtil Média",
