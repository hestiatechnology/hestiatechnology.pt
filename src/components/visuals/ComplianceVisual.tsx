...
export function ComplianceVisual() {
  return (
    <div className="w-full h-full flex items-center justify-center p-2 md:p-8 bg-gradient-to-br from-green-500/5 to-emerald-500/5">
            ...
            {[
                ...
                <div key={i} className="flex items-center justify-between p-2 rounded-lg hover:bg-muted/50 transition-colors">
                    <div className="flex items-center gap-3 overflow-hidden">
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 ${item.status === 'passed' ? 'bg-green-100 text-green-600 dark:bg-green-900/30' : 'bg-amber-100 text-amber-600 dark:bg-amber-900/30'}`}>
